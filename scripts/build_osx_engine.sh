...
CFLAGS="-m32" CXXFLAGS="-m32" cmake -DXASH_SDL=yes -DXASH_VGUI=yes -DXASH_DLL_LOADER=no -DXASH_DEDICATED=no -DHL_SDK_DIR=../vgui-dev/ -DCMAKE_OSX_ARCHITECTURES=i386 -DMAINUI_USE_STB=yes -DXASH_AUTODETECT_SSE_BUILD=no ../
make -j2
