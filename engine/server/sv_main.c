...
void SV_Init( void )
{
	...
	sv_allow_upload = Cvar_Get( "sv_allowupload", "1", 0, "allow uploading custom resources from clients" );
	sv_allow_download = Cvar_Get( "sv_allowdownload", "0", CVAR_ARCHIVE, "allow clients to download missing resources" );
