...
extern int read_mpeg_header( mpeg_t *mpg, const char *data, long bufsize, long streamsize );
extern int read_mpeg_stream( mpeg_t *mpg, const char *data, long bufsize );
