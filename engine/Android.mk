...
LOCAL_CFLAGS += -D__MULTITEXTURE_SUPPORT__ -DUSE_EVDEV -DXASH_GLES -DXASH_DYNAMIC_DLADDR -DCRASHHANDLER -DXASH_OPENSL -DXASH_FORCEINLINE -DXASH_FASTCRTLIB
...
ifeq ($(XASH_GLES2),1)
LOCAL_CFLAGS += -DXASH_GLES2_RENDER
else
LOCAL_CFLAGS += -DXASH_NANOGL
endif
...
LOCAL_SRC_FILES += client/gl_vidnt_gles2.c
LOCAL_SRC_FILES += client/gl_vidnt_android_nosdl.c
LOCAL_SRC_FILES += client/gl_shader.c
LOCAL_SRC_FILES += client/gl_emulate.c
endif
