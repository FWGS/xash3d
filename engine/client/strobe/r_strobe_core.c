...
static void R_Strobe( STROBE_IMPL_THIS_PARAM( STROBE_CORE ) )
{
	...
	{
		this->private->delta[this->base.protected->fCounter % ARRAYSIZE( this->private->delta )] = this->base.Helpers.CurrentFPS(&this->base);
		this->base.protected->deviation                                                            = this->base.Helpers.StandardDeviation( this->private->delta, ARRAYSIZE( this->private->delta ) );
	}
