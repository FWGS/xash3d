...
#define STROBE_CONCAT(SRC1, SRC2) SRC1##SRC2
#define STROBE_IMPL_EXPORTFUNC_(IMPL, FUNC) STROBE_CONCAT(IMPL, FUNC)
#define STROBE_IMPL_EXPORTFUNC(IMPL, FUNC) STROBE_IMPL_EXPORTFUNC_(STROBE_IMPL_EXPORTFUNC_(IMPL,_), FUNC) // GCC Workaround
