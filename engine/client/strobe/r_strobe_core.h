...
#define STROBE_CORE_DEVIATION_LIMIT 2.75
...
#define STROBE_CORE_private_s STROBE_CORE##_priv_s
#define STROBE_CORE_private_t STROBE_CORE##_priv_t
...
#define STROBE_CORE_EXPORTEDFUNC_destructor STROBE_CORE##_STROBE_CORE_FUNC_destructor
#define STROBE_CORE_EXPORTEDFUNC_reinit STROBE_CORE##_STROBE_CORE_FUNC_reinit
// =============

typedef struct STROBE_CORE_s STROBE_CORE_t;
typedef struct STROBE_CORE_private_s STROBE_CORE_private_t;

typedef struct STROBE_CORE_s
{
	StrobeAPI_t base;
	STROBE_CORE_private_t *private;
