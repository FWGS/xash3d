...
typedef struct STROBE_IMPL_STRUCT_S( STROBE_CORE ) STROBE_IMPL_STRUCT_T( STROBE_CORE );
typedef struct STROBE_IMPL_PRIVATE_S( STROBE_CORE ) STROBE_IMPL_PRIVATE_T( STROBE_CORE );

typedef struct STROBE_IMPL_STRUCT_S( STROBE_CORE )
{
	StrobeAPI_t base;
	STROBE_IMPL_PRIVATE_T( STROBE_CORE ) * private;
...
} STROBE_IMPL_STRUCT_T( STROBE_CORE );
extern STROBE_IMPL_STRUCT_T( STROBE_CORE ) * STROBE_CORE;
