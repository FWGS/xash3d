...
typedef int (*INITIALIZE_FUNC)	( struct  sec_cl_enginefuncs_s*, int );
...
typedef void (*DST_INITIALIZE_FUNC)	( struct  sec_cl_enginefuncs_s**, int *);
...
typedef int							(*pfnEngSrc_pfnRandomLong_t )			( int lLow, int lHigh );
...
typedef struct  sec_cl_enginefuncs_s
{
...
typedef void	(*pfnEngDst_pfnRandomLong_t )			( int *, int * );
...
{
	sec_cl_enginefunc_t	*pcl_enginefuncs;		// functions exported by the engine
	cl_enginefunc_dst_t *pg_engdstAddrs;	// destination handlers for engine exports
	sec_cldll_func_t *pcl_funcs;				// client exports
